...
function myelitecsv($id,$type)
	{
		if($type=="subbroker")
	 	...
	 	$query=$this->db->select('yc.contactname yccname,yc.company yccompany,yc.brokertype ycbrokertype,yc.contactphonenumber ycphone,yc.email ycemail,yc.registerdate ycreg,yc.subbrokerid ycsubbrokerid,yc.mainbrokerid ycmainbrokerid, yc.marketerid ycmarketerid,yc.brokerid ycbrokerid,ys.subscr_id yssubscr_id,ys.payment_date yspay,ys.expires ysexp,yc.status ycstatus')
