    	...
    	<?php echo  form_open('businessdispute/update/'.$disputeid,array('class'=>'formBox broker')) ?>
		 <fieldset>
					...
					<div class="clearfix">
						  ...
						  <div class="con">
							  <input type="text" class="input" id="date" value="<?php $dates=substr($date,0,11); echo $change=date("d-M-Y",strtotime($dates));?>">
						  </div>
					</div>
					<div class="clearfix">
						  <div class="lab">
						  ...
						  <div class="con">
							  ...
							  <input type="text" class="input" id="closedate" value="<?php $closed=substr($closedate,0,11); echo $changes=date("d-M-Y",strtotime($closed));?>">
							  <?php } ?>
						  </div>
					</div>
