<div id="sidebar"> 
  ...
  <!-- mainmenu -->
    <ul id="floatMenu" class="mainmenu">
	    ...
	    <!--Dashboard-->
	    <li class="first"><a href="<?php echo site_url('dashboard'); ?>" class="link" title="Dashboard">Dashboard</a>
		    <ul class="submenu">
		...
		<!--Profile-->
		<li><a href="<?php echo site_url('company/edit'); ?>" title="Profile">Profile</a>
			<ul class="submenu">
				...
				<li><a href="<?php echo site_url('gallery'); ?>" title="Galleries">Photo Galleries</a>
					<ul class="submenu1">
		...
		<!--Verified Seals-->
		<li><a href="<?php echo site_url('company/edit'); ?>" title="Verified Seals">Verified Seals</a>
			<ul class="submenu">
				...
				<li><a href="<?php echo site_url('review'); ?>" class="link" title="Embed Request for New Reviews">Embed Request for New Reviews</a></li>
			</ul>
		</li>
		
    
		<!--Selling Tools-->
		<li><a href="<?php echo site_url('review'); ?>" title="Selling Tools">Selling Tools</a>
			<ul class="submenu">
				<li><a href="<?php echo site_url('review'); ?>" title="Reviews">Reviews</a>
					<ul class="submenu1">
						<li><a href="<?php echo site_url('review'); ?>" class="link" title="Upload Reviews in Bulk">Upload Reviews in Bulk</a></li>
						<li><a href="<?php echo site_url('review'); ?>"  class="link" title="List All Reviews">List All Reviews</a></li>
					</ul>
				</li>
				<li><a href="<?php echo site_url('pdf'); ?>" title="Profile Docs">Menu/Catalogs</a>
					<ul class="submenu1">
			    ...
			    <li><a href="<?php echo site_url('coupon'); ?>" title="Manage Your Coupons">Manage Your Coupons</a>
					<ul class="submenu1">
		...
		<!--Resolution Center-->
		<li><a href="<?php echo site_url('review'); ?>" title="Resolution Center">Resolution Center</a>
			<ul class="submenu">
