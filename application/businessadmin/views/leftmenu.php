  ...
  <ul id="floatMenu" class="mainmenu">
   ...
   <li><a href="<?php echo site_url('pressrelease'); ?>" title="Press Releases">Press Releases</a>
    ...
    <li><a href="<?php echo site_url('pdf'); ?>" title="Profile Docs">Menu/Catalogs Upload</a>
      <ul class="submenu">
        <li><a href="<?php echo site_url('pdf/add'); ?>" title="Add Profile Docs">Add Menu/Catalogs</a></li>
        <li><a href="<?php echo site_url('pdf'); ?>" title="List All Profile Docs">List All Menu/Catalogs</a></li>
      </ul>
    </li>
