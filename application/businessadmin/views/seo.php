...
<div id="content">
  ...
  <div class="breadcrumbs">
    <ul>
      ...
      <li>
        <?php if($this->uri->segment(2) == 'add'){echo 'Add SEO Tools';} else if($this->uri->segment(2) == 'edit') {echo 'Edit SEO Tools'; }?>
      </li>
    </ul>
  </div>
  <!-- /breadcrumbs -->
    ...
    <div class="box-content"> <?php echo form_open('seo/update',array('class'=>'formBox','id'=>'frmseo')); ?>
      <fieldset>
        ...
        <?php echo form_hidden( array( 'my' => $seo[0]['fieldname']) ); ?>
          <div class="lab float_none" style="width: auto; padding-bottom:5px">
  ...
  <div class="box">
    <div class="headlines">
      <h2><span><?php echo "SEO Tools" ?></span></h2>
    </div>
