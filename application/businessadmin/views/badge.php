...
<div class="box">
    ...
    <table class="tab tab-drag">
     ...
     <tr class="odd">
        <td>Badge Url</td>
        <td>
        <textarea cols='90' rows='10'><a href="<?php echo 'http://yougotrated.writerbin.com/badge/rating/'.md5($this->session->userdata['youg_admin']['id']);?>" target="_blank" title="Get Widget">
        <img src="../../images/badge.png" class="logo_btm" alt="Yougotrated" title="Yougotrated"  width='10%' height='100px'></a></textarea></td></tr>
        <tr class="odd">
        <td>Sample Image</td>
        <td>
	<a href="<?php echo 'http://yougotrated.writerbin.com/badge/rating/'.md5($this->session->userdata['youg_admin']['id']);?>" target="_blank" title="Get Widget">
