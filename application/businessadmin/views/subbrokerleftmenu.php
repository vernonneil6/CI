<div id="sidebar"> 
  <ul id="floatMenu" class="mainmenu">
    ...
    <li><a href="<?php echo site_url('subbroker'); ?>" title="Agent">Elite Member</a>
      <ul class="submenu">
        <li><a onclick="this.target='_blank';" href="<?php echo 'http'.(empty($_SERVER['HTTPS'])?'':'s').'://'.$_SERVER['SERVER_NAME'].'/signuppage/affid/'.$this->session->userdata['subbroker_data'][0]->id;?>" title="Create Elite Member">Create Elite Member</a></li>
