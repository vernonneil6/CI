...
<div id="header"> 
	...
	<div id="user" align="right">
	    <?php echo "logged in as ".$this->session->userdata['marketer_data'][0]->username; ?>
	    <a href="<?php echo site_url('marketer');?>" title="Dashboard">Dashboardd</a> - <a href="<?php echo site_url('marketer/logout');?>" title="Logout">Logout</a>
	</div>
</div>