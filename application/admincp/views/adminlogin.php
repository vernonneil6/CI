...
<div id="main">
  <div id="content">
    <div id="login">
      <div id="logo"><span><?php echo $site_name; ?></span></div>
      
      <!-- Error form message -->
      <?php if( $this->session->flashdata('error') ) { ?>
      <div class="form-message error" id="message-red"> <?php echo $this->session->flashdata('error'); ?> <a class="close-red"><img src="<?php echo base_url(); ?>images/error.gif" alt="Close"/></a> </div>
      <?php } ?>
      ...
      <fieldset>
        ...
        <div class="form-col form-col-right"> <?php echo form_input(array('name'=> 'btnsubmit','id'=>'btnsubmit','class'=> 'submit','type'=>'submit','value'=>'Login')); ?> </div>
      </fieldset>
