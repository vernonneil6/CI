<div id="sidebar">   
  <ul id="floatMenu" class="mainmenu">
	...
	<li class="<?=($this->uri->segment(1)==='mainbroker')?'active':''?>">
		<a href="<?php echo site_url('mainbroker'); ?>" title="Multi-Tier Marketing">Affiliate Program</a>
		<ul class="submenu">
			<li>
	...
	<li class="<?=($this->uri->segment(1)==='email')?'active':''?>">
		<a href="<?php echo site_url('email');?>" class="link" title="Email Formats">Automated Emails</a>
    </li>
    ...
    <li class="<?=($this->uri->segment(1)==='coupon')?'active':''?>">
		...
		<ul class="submenu">
			...
			<li>
				<a href="<?php echo site_url('couponcomment'); ?>" title="List All Comments">List All Comments on Coupons</a>
			</li>
		</ul>
    </li>
    ...
    <li class="<?=($this->uri->segment(1)==='faq')?'active':''?>">
		<a href="<?php echo site_url('faq'); ?>" title="FAQs">FAQs for Elite Members</a>
		<ul class="submenu">
			<li>
    ...
    <li class="<?=($this->uri->segment(1)==='page')?'active':''?>">
		<a href="<?php echo site_url('page'); ?>" title="Edit Pages">Footer Pages</a>
		<ul class="submenu">
			<li>
    ...
    <li class="<?=($this->uri->segment(1)==='review')?'active':''?>">
		<a href="<?php echo site_url('review'); ?>" title="Business Reviews">Reviews</a>
		<ul class="submenu">
			<li>
				<a href="<?php echo site_url('review'); ?>" title="List All Reviews">List All Reviews</a>
			</li>
			<li>
				<a href="<?php echo site_url('review/removed'); ?>" title="Search Review">Removed Reviews</a>
			</li>
			<li>
