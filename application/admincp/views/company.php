...
<?php echo $header; ?> 
				...
				<div class="form-cols"><!-- two form cols -->
				  <div class="col1">
					<div class="clearfix">
					  ...
					  <div class="con"> <?php echo form_input( array( 'name'=>'keysearch','id'=>'keysearch','class'=>'input','type'=>'text','placeholder'=>'Search company by name or email or discription','value'=>'')); ?> </div>
					</div>
				  </div>
				  <div id="keysearcherror" style="display:none;" class="error" align="right">Enter Keyword.</div>
				</div>
		...
		<thead>
			...
			<th <?php if ($sort_by == $field_name) echo "class=\"sort_$sort_order sorttitle \"" ?>>
				<?php 
				 ...
				 ?>
				<?php echo anchor("company/index/$field_name/" .
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php
						...
						if ($field_name == 'status' ) { 
							if( $company->$field_name == 'Enable' ){ ?>
								<a href="<?php echo site_url('company/disable/'.$company->id);?>" title="Click to Disable" class="btn btn-small btn-success" onClick="return confirm('Are you sure to Disable this user?');"><span><?php echo $company->$field_name; ?></span></a>
								
							<?php 
							}else{ ?>
								
							<a href="<?php echo site_url('company/enable/'.$company->id);?>" title="Click to Enable" class="btn btn-small btn-success" style="cursor:default; color: #CD0B1C;" onClick="return confirm('Are you sure to Enable this user?');"><span><?php echo $company->$field_name; ?></span></a>
						 <?php
							}
				...
				<?php endforeach; ?>
				<td>
					<a href="<?php echo site_url('company/edit/'.$company->id); ?>" title="Edit" class="ico ico-edit">Edit</a> 					
					<a href="<?php echo site_url('company/delete/'.$company->id);?>" title="Delete" class="ico ico-delete" onClick="return confirm('Are you sure to Delete this user?');">Delete</a>
					<a href="<?php echo site_url('company/view/'.$company->id); ?>" title="View Company Details" class="colorbox"><img width="16" height="17" border="0" src="images/detail.jpeg" alt="view"></a>
				</td>
				<td>
					<a href="<?php echo site_url('coupon/add'); ?>" title="Add Coupon">
						<img width="16" height="17" border="0" src="images/Add-icon.png" alt="view">
					</a>
				</td>
				<td>
				<?php $mem = $this->settings->get_elite_status_of_companyid($company->id);
				
				 if(count($mem)==0)
				{?>
				<a href="<?php echo site_url('company/makeelite/'.base64_encode($company->id)); ?>" title="Make Elite Member" onClick="return confirm('Are you sure to Make this company an Elite Member ?');">
					<img width="16" height="17" border="0" src="images/Add-icon.png" alt="view">
				</a>
				<?php }
				else
