    ...
    <div class="clearfix file">
        ...
        <div class="clearfix file">
          ...
          <div class="con">
              ...
              Maximum width allowed : <?php  echo $this->config->item('ad_max_width');?>px<br />
              Maximum height allowed : <?php echo $this->config->item('ad_max_height');?>px<br/>
              Maximum upload size : <?php echo $this->config->item('ad_max_size');?>kb
