	...
	*/
	...
	public function buycurrency()
	{
		 ...
		 if( $this->input->is_ajax_request())
		 {
			  ...
			  $buyamount=$this->input->post('buyamount');
				...
				if($this->homes->buycurrency($base_price,$buyamount,$buytotaltext,$feescalculationtext,$buybasecurrency,$interfaceexid,$interface))
				{
	...
	public function sellcurrency()
	{
		 ...
		 if($interfaceexid!='')
		 {
				...
				if($this->homes->sellcurrency($base_price,$buyamount,$buytotaltext,$feescalculationtext,$buybasecurrency,$interfaceexid,$interface))
				{
						$main_price=$this->homes->set_main_price($interfaceexid);	
