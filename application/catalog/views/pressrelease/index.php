...
<section class="container">
  <section class="main_contentarea">
    <div class="innr_wrap">
	 ...
	 <!--<a href="#"><img src="./images/YouGotRated_HeaderGraphics_press_release.png" alt="Press Realease" title="Business Directory"></a>-->
        ...
        <?php for($i=0; $i<count($pressreleases); $i++) { ?>
          <div class="pre_blck">
            ...
            <div class="pre_titlewrp">
              <h3><a class="pressfact" href="<?php echo site_url('company/'.$pressreleases[$i]['companyseokeyword'].'/reviews/coupons/complaints');?>" title="view <?php echo stripslashes(ucfirst($pressreleases[$i]['company'])); ?>'s detail"><?php echo stripslashes(ucfirst($pressreleases[$i]['company'])); ?></a></h3>
              <p><a class="pressnotice" href="<?php echo site_url('pressrelease/browse/'.$pressreleases[$i]['seokeyword']); ?>" title="view <?php echo stripslashes(ucfirst($pressreleases[$i]['title'])); ?>'s detail">"<?php echo substr(stripslashes(ucfirst($pressreleases[$i]['title'])),0,50)."..."; ?>"</a></p>
            </div>
          </div>
          <?php } }else
		  {
