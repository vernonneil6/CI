          ...
          <div class="revw_blck">
			  ...
			  <div class="revw_blck_cnt">
				...
				<div class="revw_occupt"> 
					<span>
						<a class = "font_color_white" href="<?php echo site_url('pressrelease/browse/'.$pressreleases[$i]['seokeyword']); ?>" title="view <?php echo stripslashes(ucfirst($pressreleases[$i]['title'])); ?>'s detail">"<?php echo substr(stripslashes(ucfirst($pressreleases[$i]['title'])),0,50)."..."; ?>"</a>
					</span>
				</div>
