      ...
      <div class="login_box_div" style="width:740px; margin-top:0; min-height:330px">
        <div class="box" style="width:90% !important;"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td valign="top" colspan="2"><div class="post_content_title" style="padding-bottom:0; height:auto;margin-bottom:5px;">
                  <h1 style="font-size:24px !important;"><?php echo stripslashes($company[0]['company']); ?></h1>
                </div></td>
            </tr>
            <tr>
              <td width="110px;"><img src="<?php if( $company[0]['logo'] ){ echo $this->common->get_setting_value('2').$this->config->item('company_main_upload_path');?><?php echo stripslashes($company[0]['logo']); } else { echo $this->common->get_setting_value('2').$this->config->item('company_thumb_upload_path')."/no_image.png"; } ?>" width="100px" height="100px" alt="<?php echo ucfirst(stripslashes($company[0]['company'])); ?>"/></td>
...
google.maps.event.addDomListener(window, 'load', initialize);
          ...
          <ul class="tabs" style="margin-top:25px;font-size:12px;">
            ...
            <span class="item"> <span class="fn"><?php echo ($company[0]['company']);?> Reviews</span></span> Review <span class="rating">Rating: <span class="average"><?php echo $lastavg;?></span> out of <span class="best">5</span> </span> based on <span class="count"><?php echo count($reviews)+ count($companyreviews);?></span> reviews. </span>
            <li rel="tab1">Complaints &nbsp;(<?php echo count($complaints);?>)</li>
            <?php } else { ?>
            <li class="active" rel="tab1">Complaints &nbsp;(<?php echo count($complaints);?>)</li>
            <li rel="tab2">Reviews &nbsp;(<?php echo count($reviews)+ count($companyreviews);?>) <span class="hreview-aggregate" style="display:none;">
              <?php if(count($reviews)>0)
                    {
                        $totalrates = 0;
                        for($j=0;$j<count($reviews);$j++)
              ...
              <span class="item"> <span class="fn"><?php echo ($company[0]['company']);?> Reviews</span></span> Review <span class="rating">Rating: <span class="average"><?php echo $lastavg;?></span> out of <span class="best">5</span> </span> based on <span class="count"><?php echo count($reviews)+ count($companyreviews);?></span> reviews. </span> </li>
            <?php } ?>
          ...
          <div class="tab_container">
              ...
              <div class="main_livepost">
                <div class="post_maincontenttab">
                  ...
                  <div class="post_username">
                    ...
                    <a><?php echo $reviews[$i]['reviewby'];?></a> <a href="<?php echo site_url('review/browse/'.$reviews[$i]['seokeyword']);?>" title="add comment">Add comment</a>
                    <?php } else {?>
            ...
            <div id="tab2" class="tab_content"> <a href="<?php echo site_url('company/reviews/'.$company[0]['companyseokeyword'].'/reviews/coupons/complaints');?>" title="View All">View All</a>
              ...
              <div class="main_livepost">
                <div class="post_maincontenttab">
                  <div class="post_content_dscrtab user_view"> <a title=""><?php echo stripslashes($companyreviews[$x]['comment']); ?></a> <br/>
                    <br/>
              ...
              <div class="main_livepost">
                <div class="post_maincontenttab">
                  ...
                  <?php 
                        ...
                        if($newdate > 60){$diff = round(($d1-$d2)/60/60).' hours ago';}else{$diff = $newdate.' minutes ago';}
                        ?>
                  <div class="timing"> <a href="<?php echo $coupons[$i]['url'];?>" title="Promocode" target="_blank" rel="nofollow">Promocode: <span><?php echo $coupons[$i]['promocode'];?></span> </a> </div>
	 ...
	 if( count($elite)==0 )
      ...
      <div class="right_content_panel">
        ...
        <div class="filter"><span style="font-size:14px; font-weight:bold;">Filter by :</span> <a href="<?php echo site_url('complaint');?>" class="filter_active" title="Recent Activity">Recent Activity</a> <a href="<?php echo site_url('complaint/weektrending');?>" title="Trending Complaints">Trending Complaints (7 Days)</a> <!--<a href="#">Most Active (7 Days)</a>--><a href="<?php echo site_url('complaint/advfilter');?>"><span class="advfilterspan"><span id="advfilter" style="cursor: pointer;">Advance Filter</span></span></a></div>
