...
google.maps.event.addDomListener(window, 'load', initialize);
            ...
            <div class="dir_content_dscr" style="width:282px;margin-left:100px;"> <a href="<?php echo site_url($companies[$i]['seoslug']);?>" title="view <?php echo stripslashes(ucfirst($companies[$i]['company'])); ?>'s detail"><?php echo stripslashes($companies[$i]['streetaddress']); ?></a> </div>
            <div class="dir_content_dscr" style="width:282px;margin-left:100px;"> <a href="<?php echo site_url($companies[$i]['seoslug']);?>" title="view <?php echo stripslashes(ucfirst($companies[$i]['company'])); ?>'s detail"><?php echo ucfirst(stripslashes($companies[$i]['city'])); ?></a> </div>
            <div class="dir_content_dscr" style="width:282px;margin-left:100px;"> <a href="<?php echo site_url($companies[$i]['seoslug']);?> ?>" title="view <?php echo stripslashes(ucfirst($companies[$i]['company'])); ?>'s detail"><?php echo ucfirst(stripslashes($companies[$i]['state'])); ?></a> </div>
            <div class="dir_content_dscr" style="width:282px;margin-left:122px;"> <a href="<?php echo site_url($companies[$i]['seoslug']);?>" title="view <?php echo stripslashes(ucfirst($companies[$i]['company'])); ?>'s detail"><?php echo ucfirst(stripslashes($companies[$i]['country'])); ?></a> </div>
            <div class="dir_content_dscr" style="width:282px;margin-left:122px;"> <a href="<?php echo site_url($companies[$i]['seoslug']);?>" title="view <?php echo stripslashes(ucfirst($companies[$i]['company'])); ?>'s detail"><?php echo stripslashes($companies[$i]['zip']); ?></a> </div>
            ...
            <div class="dir_content_dscr" style="width:282px;margin-left:122px;"> <a href="<?php echo site_url($companies[$i]['seoslug']);?>" title="view <?php echo stripslashes(ucfirst($companies[$i]['company'])); ?>'s detail"><?php echo stripslashes($companies[$i]['phone']); ?></a> </div>
          </div>
        </div>
        <?php } ?>
