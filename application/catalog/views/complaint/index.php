  ...
  <section class="main_contentarea">
    <div class="innr_wrap">
      ...
      <div class="dir_rew_wrap">
        ...
        <div class="revw_blck_img"><div class="vry_logo"> <a href="<?php echo site_url($complaints[$i]['company_seoslug']);?>" title="view company Detail"><img src="images/notverified.png" class = "reviewnotverifiedlogo" alt="<?php echo ucfirst(stripslashes($complaints[$i]['company'])); ?>" /></a> </div> </div>
        <?php }else{
				  ?>
        <div class="revw_blck_img"><div class="vry_logo"> <a href="<?php echo site_url($complaints[$i]['company_seoslug']);?>" title="view company Detail"><img src="images/verifiedlogo.jpg" class = "reviewverifiedlogo" alt="<?php echo ucfirst(stripslashes($complaints[$i]['company'])); ?>" /></a> </div></div>
        <?php
				  } ?>
          <?php 
