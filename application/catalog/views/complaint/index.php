  ...
  <section class="main_contentarea">
    <div class="innr_wrap">
      ...
      <div class="dir_rew_wrap">
        ...
        <div class="revw_blck_img"> <a href="<?php echo site_url('company/'.$complaints[$i]['companyseokeyword'].'/reviews/coupons/complaints');?>" title="view company Detail"><img src="images/YouGotRated_BusinessProfile_NotVerified-ReviewsTag.png" alt="<?php echo ucfirst(stripslashes($complaints[$i]['company'])); ?>" /></a> </div>
        <?php }else{
				  ?>
        <div class="revw_blck_img"> <a href="<?php echo site_url('company/'.$complaints[$i]['companyseokeyword'].'/reviews/coupons/complaints');?>" title="view company Detail"><img src="images/verified_img.png" alt="<?php echo ucfirst(stripslashes($complaints[$i]['company'])); ?>" /></a> </div>
        <?php
				  } ?>
          <?php 
