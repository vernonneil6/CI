        ...
        { 
	     for($i=0; $i<count($complaints); $i++) 
         {
          ...
          <div class="revw_blck_img">
			  <div class="vry_logo"> 
				  <a href="<?php echo site_url($complaints[$i]['company_seoslug']);?>" title="view company Detail"><img src="images/notverified.png" class = "reviewnotverifiedlogo" alt="<?php echo ucfirst(stripslashes($complaints[$i]['company'])); ?> Notverified Seal" />
				  </a> 
				  </div> 
				  </div>
          <?php }else{
          ...
          <div class="revw_blck_img">
			  <div class="vry_logo"> 
				  <a href="<?php echo site_url($complaints[$i]['company_seoslug']);?>" title="view company Detail"><img src="images/verifiedlogo.png" class = "reviewverifiedlogo" alt="<?php echo ucfirst(stripslashes($complaints[$i]['company'])); ?> Verified Seal" />
				  </a> 
			  </div>
		  </div>
          <?php
