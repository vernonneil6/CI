...
<div id="review_popup" class = "popupwidth">
	...
	<iframe id="container_frame" src="<?php echo 'http'.(empty($_SERVER['HTTPS'])?'':'s').'://'.$_SERVER['SERVER_NAME']. '/widget/content/'.$companyid; ?>"  style="width:100%;height:100%;border:none;position:relative;" ></iframe>
</div> 
</div>
