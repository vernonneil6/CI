...
<?php } ?>				
				...
				<label>I am authorized to act on behalf of the above named company and agree to the <a target="_blank" href="<?php echo site_url('footerpage/index/2');?>" class="receiptterms">Terms and Conditions</a> of use and agree that this membership will be automatically renewed monthly until cancelled.</label>
