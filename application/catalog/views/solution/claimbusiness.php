...
<section class="container">
  <section class="main_contentarea">
    <div class="banner_wrp"> 
		<img class="containerimg" src="images/YouGotRated_HeaderGraphics_SignUpPage.png" alt="Register" title="Register"> 
    </div>
    <div class="regr_lnk">
      <div class="innr_wrap">
      ...
      <div class="reg_frm_wrap" style="width:100%;">
		...
		<div class="reg-row" style="margin-top:55px;">	
			...
			<div class="form-col-2">
				...
				<div id="termscondn" style="margin-top:27px; display:inline-block;font-family: myriadpro-regular;">
