      ...
      <div class="login_box_div" style="width:740px; margin-top:0; min-height:330px">
        <div class="box"> 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="460" valign="top" colspan="2"><div class="post_content_title" style="padding-bottom:0; height:auto">
                  <h1 style="font-size:24px !important;"><?php echo stripslashes($coupons[0]['company']); ?></h1>
                </div></td>
            </tr>
            <tr height="50" valign="middle">
              <td colspan="3"><?php $date = date_default_timezone_set('Asia/Kolkata');                             
                ...
                <div class="timing"> <a href="<?php echo $coupons[0]['url'];?>" target="_blank" title="Promocode" rel="nofollow"> <?php echo "Promocode: ";?><span><?php echo $coupons[0]['promocode'];?></span> </a> <a title="Expires"> <?php echo "Expires: ";?><span><?php echo date('m/d/Y',strtotime($dbdate));?></span> </a><a title="Category"> <?php echo "Category: ";?><span><?php echo $coupons[0]['category'];?></span> </a> </div></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="80">
...
" style="width:600px;" /></td>
          ...
          <table border="0" style="background:none repeat scroll 0 0 #F6F6F6;padding-left:10px;margin-top:10px;" width="100%">
		   ...
		   ?>" alt="<?php echo stripslashes($user[0]['username']); ?>"/> </div></td>
            ...
            <tr>
              <td colspan="2"><?php echo stripslashes($couponcomments[$k]['comment']); ?></td>
            </tr>
            <?php
					}
					?>
          ...
          <table>
            ...
            <tr>
              <td colspan="2"><?php if( array_key_exists('youg_user',$this->session->userdata) ) { ?>
                ...
                <?php } ?>
                <?php } else {?>
                Please <span class="user_view"><a href="<?php echo site_url('login');?>" title="login">login</a></span> to add comment...
                <?php } ?>
                <?php if( array_key_exists('youg_user',$this->session->userdata) ) { ?>
