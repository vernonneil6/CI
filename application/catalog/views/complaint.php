...
?>
                  ...
                  <div class="post_content_dscr user_view" style="min-width:500px;"> <a href="<?php echo site_url($complaints[$i]['clink']);?>" title="view detail"> <?php echo strtolower(substr(stripslashes($complaints[$i]['cdetail']),0,212)."..."); ?></a></div>
                </div>
              </div>
            </div>
            <?php }
      ...
      <div class="login_box_div" style="width:740px; margin-top:0; min-height:330px">
        <div class="box"> 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td></td>
              <td style="padding-left:10px;">&nbsp;<b>Email</b>:&nbsp;<a href="mailto:<?php echo stripslashes($company[0]['email']); ?>" title="<?php echo stripslashes($company[0]['email']); ?>"><?php echo stripslashes($company[0]['email']); ?></a></td>
              <td></td>
            </tr>
            <tr>
              <td></td>
              <td style="padding-left:10px;">&nbsp;<b>Website</b>:&nbsp;<a href="http://<?php echo stripslashes($company[0]['siteurl']); ?>" class="company_content_title" title="<?php echo stripslashes($company[0]['siteurl']); ?>"><?php echo stripslashes($company[0]['siteurl']); ?></a></td>
              <td></td>
            </tr>
            <tr>
              <td></td>
...
google.maps.event.addDomListener(window, 'load', initialize);
              ...
              <div class="main_livepost">
                <div class="post_maincontenttab">
                  ...
                  <?php 
                        ...
                        if($newdate > 60){$diff = round(($d1-$d2)/60/60).' hours ago';}else{$diff = $newdate.' minutes ago';}
                        ?>
                  <div class="timing"> <a href="" title="Date occurred">Date occurred: <span><?php echo date('m/d/Y',strtotime($dbdate));?></span> </a> </div>
                  <div class="post_username"> <a href="" title="<?php echo $companyreviews[$x]['username'];?>"><?php echo $companyreviews[$x]['username'];?></a> </div>
                </div>
              </div>
              <?php } ?>
              <?php } ?>
                    ...
                    <div class="main_livepost" style="border-bottom: 1px solid #CCCCCC;">
                      <div class="post_maincontenttab">
                        ...
                        <div class="post_username">
                          ...
                          <?php } else { ?>
                          <a href="" title="<?php echo "Anonymous";?>"><?php echo "Anonymous";?></a>
                          <?php	}?>
                    ...
                    <div class="main_livepost" style="border-bottom: 1px solid #CCCCCC;">
                      <div class="post_maincontenttab">
                        ...
                        <div class="post_username">
                          ...
                          <a href="<?php echo site_url('complaint/viewuser/'.$complaints[$i]['companyid'].'/'.$complaints[$i]['userid']); ?>" title="view profile"><?php echo $user[0]['username'];?></a>
                          <?php } else { ?>
                          <a href="" title="Anonymous"><?php echo "Anonymous";?></a>
                          <?php	}?>
                          <a href="<?php echo site_url('complaint/browse/'.$complaints[$i]['comseokeyword']); ?>" title="view complaint detail"><span><?php echo ($complaindate==$today)?'Posted: '.$diff:'Posted: '.date('m/d/Y',strtotime($complaints[$i]['complaindate'])); ?></span></a> </div>
                      </div>
                    </div>
              ...
              <div class="main_livepost">
                <div class="post_maincontenttab">
                  ...
                  <?php 
                        ...
                        ?>
                  <div class="timing"> <a href="" title="Date occurred">Date occurred: <span><?php echo date('m/d/Y',strtotime($dbdate));?></span> </a> </div>
                  <div class="post_username"> <a href="" title="username"><?php echo $companyreviews[$x]['username'];?></a> </div>
                </div>
              </div>
              <?php } ?>
              <?php } ?>
      ...
      <table border="0">
        ...
        <tr>
          <td><?php if($rightads){ ?>
            <div><a href="<?php echo $rightads[0]['url'];?>" title="Adverstiment" target="_blank" rel="nofollow"><img src="<?php if( $rightads[0]['image'] ) { echo $this->common->get_setting_value('2').$this->config->item('ad_main_upload_path');?><?php echo stripslashes($rightads[0]['image']); } ?>" alt="Adverstiment" width="224" height="180" class="adimg" style="margin-left:5px;"/></a> </div>
            <?php } ?></td>
        </tr>
      </table>
      <?php }
	...
	$(document).ready(function() {
       $('.selectdrop').selectbox({ inputClass: "styledselectbox" });
        ...
        <div class="dir_title" style="padding-bottom:15px;margin-top:15px;">
          <h1 style="font-size:24px !important;">Elite Membership</h1>
        </div>
        <?php if( $this->session->flashdata('success') ) { ?>
        <!--  start message-green -->
        <div id="message-green">
        ...
        <table class="data_table" align="left" width="900px">
          <tbody>
            ...
            <tr>
              <td></td>
              <td colspan="2"><?php echo form_checkbox(array('name'=>'readterms','type'=>'checkbox','id'=>'readterms','value'=>'Yes')); ?>&nbsp;I have read the <a href="<?php echo site_url('eliteterms');?>" target="_blank" class="colorcode" title="Terms and Conditions">Terms and Conditions</a><br/>
      ...
      <div class="right_content_panel">
        ...
        <div class="filter"><span style="font-size:14px; font-weight:bold;">Filter by :</span> <a href="<?php echo site_url('welcome');?>" title="Recent Activity">Recent Activity</a> <a href="<?php echo site_url('complaint/weektrending');?>" title="Trending Complaints">Trending Complaints (7 Days)</a><!-- <a href="#">Most Active (7 Days)</a>--><a href="<?php echo site_url('complaint/advfilter');?>" class="filter_active" title="Advance Filter">Advance Filter</a></div>
      </div>
      ...
      <div class="right_content_panel">
        ...
        <div class="filter"><span style="font-size:14px; font-weight:bold;">Filter by :</span> <a href="<?php echo site_url('complaint');?>" title="Recent Activity">Recent Activity</a> <a href="<?php echo site_url('complaint/weektrending');?>" class="filter_active" title="Trending Complaints">Trending Complaints (7 Days)</a><!-- <a href="#">Most Active (7 Days)</a>--><a href="<?php echo site_url('complaint/advfilter');?>" title="Advance Filter"><span class="advfilterspan"><span id="advfilter" style="cursor: pointer;">Advance Filter</span></span></a></div>
      ...
      <div class="right_content_panel">
        ...
        <div class="filter"><span style="font-size:14px;font-weight:bold;">Filter by :</span> <a href="<?php echo site_url('complaint');?>" title="Recent Activity">Recent Activity</a> <a href="<?php echo site_url('complaint/weektrending');?>" title="Trending Complaints">Trending Complaints (7 Days)</a><!-- <a href="#">Most Active (7 Days)</a>--> <a href="<?php echo site_url('complaint/advfilter');?>" class="filter_active" title="Advance Filter">Advance Filter</a></div>
      ...
      <div class="left_content_panel">
        ...
        <table border="0" align="left">
          ...
          <tr>
            <td><?php if($leftads){ ?>
              <div><a href="<?php echo $leftads[0]['url'];?>" title="Adverstiment" target="_blank" rel="nofollow"><img src="<?php if( $leftads[0]['image'] ) { echo $this->common->get_setting_value('2').$this->config->item('ad_main_upload_path');?><?php echo stripslashes($leftads[0]['image']); } ?>" alt="Adverstiment" width="280" height="180" class="adimg"/></a> </div>
              <?php } ?></td>
          </tr>
        </table>
      </div>
