    ...
    <div class="main_contentarea">
      ...
      <div class="right_content_panel">
        ...
        <div class="main_livepost">
          <div class="view_all"> 
			<a href="<?php echo site_url('company').'/'.$coupons[$i]['companyseokeyword'].'/reviews/coupons/complaints';?>" title="view all"> 
				<span>
				<h3>
				  <?php 
				  $num=$this->coupons->get_coupon_bycompanyid($coupons[$i]['companyid']); 
				  if(count($num)>0)
				  { 
					echo count($num); 
				  }
			...
			<a href="<?php echo site_url('company').'/'.$coupons[$i]['companyseokeyword'].'/reviews/coupons/complaints';?>" title="view all">View All</a>
		  </div>
