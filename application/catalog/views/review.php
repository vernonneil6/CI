  ...
  <section class="inner_main">
    ...
    <?php if($topads){ ?>
      ...
      <div class="dir_panel" style="width:980px; font-size:14px; color:#333333">
        <?php if($this->uri->segment(2) == 'add'){?>
        <div class="dir_title"><h1 style="font-size:24px !important;">Review : <?php echo $company[0]['company'];?></h1></div>
        <?php } else {?>
        <div class="dir_title"><h1 style="font-size:24px !important;">Review : <?php echo $review[0]['company'];?></h1></div>
        <?php } ?>
        <div id="tab-Testing"> 
          <script type="text/javascript" language="javascript">
          $(function(){  
      ...
      <?php } 
		?>
      <div class="dir_panel">
        <div class="dir_title"><h1 style="font-size:24px !important;">Business Review</h1></div>
      ...
      <div class="dir_panel" style="width:980px; font-size:14px; color:#333333"> 
        ...
        <a title="<?php echo stripslashes($review[0]['reviewby']); ?>"> <?php echo stripslashes($review[0]['reviewby']); ?></a>
        ...
        <table width="980" border="0" cellspacing="0" cellpadding="0" class="job-table" style="border:none">
          ...
          <tr>
            ...
            <td colspan="2" style="color:#333333; padding-bottom:10px; padding-top:10px">Add your vote:
              ...
              <a class="vote-disable" id="helpfula_<?php echo $review[0]['id'];?>" reviewid="<?php echo $review[0]['id'];?>" title="Helpful">Helpful</a>
              <?php } else {?>
              <a class="vote" id="helpfula_<?php echo $review[0]['id'];?>" reviewid="<?php echo $review[0]['id'];?>" title="Helpful">Helpful</a>
              <?php } ?>
              ...
              <a id="agreea_<?php echo $review[0]['id'];?>" class="vote-disable" reviewid="<?php echo $review[0]['id'];?>" title="Agree">Agree</a>
              <?php } else {?>
              <a id="agreea_<?php echo $review[0]['id'];?>" class="vote" reviewid="<?php echo $review[0]['id'];?>" title="Agree">Agree</a>
              <?php } ?>
      ...
      <div class="dir_panel"> 
        ...
        <div class="dir_title" style="width:auto;padding-bottom:15px;"><h1 style="font-size:24px !important;">Business Review</h1>
          <div class="my" style="float:right;padding-bottom:-10px;"> <a href="<?php echo site_url('welcome');?>" title="submit a complaint"><?php echo form_input(array('name'=>'submitacomplaint','id'=>'submitacomplaint','class'=>'complaint_btn','type'=>'button','value'=>'Submit a complaint','style'=>'padding:7px 25px;cursor: pointer;')); ?></a> </div>
        </div>
        ...
        <table width="980" border="0" cellspacing="0" cellpadding="0" class="job-table" style="border:none">
          ...
          <tr>
            ...
            <td colspan="2" style="color:#333333; padding-bottom:10px; padding-top:10px">Add your vote:
              ...
              <a class="vote-disable" id="helpful_<?php echo $reviews[$i]['id'];?>" reviewid="<?php echo $reviews[$i]['id'];?>" title="Helpful">Helpful</a>
              <?php } else {?>
              ...
              <a id="agree_<?php echo $reviews[$i]['id'];?>" class="vote-disable" reviewid="<?php echo $reviews[$i]['id'];?>" title="Agree">Agree</a>
              <?php } else {?>
