  ...
  <section class="main_contentarea">
    <?php  //get avg star by cmpyid
      ...
      <div class="verified_wrp pr_rwrp pr_rwrp">
        ...
        <div class="vry_logo"> <a href="<?php echo site_url('company/'.$coupons[0]['companyseokeyword'].'/reviews/coupons/complaints');?>" title="view company Detail"><img src="images/notverified.png" class="imgverify" alt="<?php echo ucfirst(stripslashes($coupons[0]['company'])); ?>" /></a> </div>
        <?php }else{ ?>
        <div class="vry_logo"> <a href="<?php echo site_url('company/'.$coupons[0]['companyseokeyword'].'/reviews/coupons/complaints');?>" title="view company Detail"><img src="images/verifiedlogo.jpg" class="imgverify" alt="<?php echo ucfirst(stripslashes($coupons[0]['company'])); ?>" /></a> </div>
        <?php  } ?>
