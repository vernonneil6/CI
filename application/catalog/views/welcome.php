...
<section class="container">
  <section class="inner_main">
    <div class="main_contentarea"> <?php echo $menu; ?>
      <div class="complain_tag">
        <h1 style="font-size:24px;"><?php echo $tag_line;?></h1>
        <?php if($topads){ ?>
      ...
      <div class="main_complain_div">
        ...
        <script src="<?php echo base_url();?>js/datetimepicker/jquery-ui-timepicker-addon.js" defer="defer"></script> 
        <script>
	...
	function searchcompany(company)
	{
        ...
        <div class="complain_leftmainbox">
          ...
          <div class="complain_box" id="divcomplaint">
            <div class="complain_box_title"><img src="<?php echo site_url();?>images/step1.png" alt="step1" width="31" height="31"><span>&nbsp;I wish to file a complaint against:</span> </div>
            <div class="complain_textboxdiv"> <?php echo form_input( array( 'name'=>'company','id'=>'company','class'=>'complain_txtbox','type'=>'text','placeholder'=>'enter minimum 4 characters to search company...','onkeyup'=>'searchcompany(this.value)','style'=>'width:430px;')); ?> <img src="<?php echo base_url();?>images/ajax-load.gif" id="imgload" alt="ajax" height="16" width="16"/>
          ...
          <div class="complain_box" id="divtype">
            <div class="complain_box_title"><img src="<?php echo site_url();?>images/step2.png" alt="step2" width="31" height="31"><span>&nbsp;Select a complaint type:</span> </div>
            <div class="complain_textboxdiv">
              <ul>
                <li><a id="lnkcompany" title="Company">Company</a></li>
                <li><a id="lnkperson" title="Person">Person</a></li>
                <li><a id="lnkphone" title="Phone">Phone</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="complain_box" id="divstep2">
            ...
            <div class="complain_textboxdiv" id="divcompany"> 
              ...
              <table cellspacing="0" cellpadding="2" border="0">
                ...
                <tr>
                  <td colspan="2"><?php echo form_checkbox(array('name'=>'readterms','type'=>'checkbox','id'=>'readterms','value'=>'Yes')); ?>&nbsp;I have read the <a href="<?php echo site_url('complaintterms');?>" target="_blank" class="colorcode" title="Terms and Conditions">Terms and Conditions</a></td>
                </tr>
                <tr>
        ...
        <div class="complain_rightmainbox">
          <div class="complain_form_title"><img src="<?php echo site_url();?>images/complain_title.png" alt="complain" width="279" height="67"></div>
  ...
  <section class="inner_main">
    <div class="main_contentarea">
      ...
      <div class="left_content_panel">
        ...
        <?php if($leftads){ ?>
        <div><a href="<?php echo $leftads[0]['url'];?>" title="Adverstiment" target="_blank" rel="nofollow"><img src="<?php if( $leftads[0]['image'] ) { echo $this->common->get_setting_value('2').$this->config->item('ad_main_upload_path');?><?php echo stripslashes($leftads[0]['image']); } ?>" alt="leftads" width="280" height="180" class="adimg"/></a> </div>
        <?php } ?>
      </div>
      <div class="right_content_panel">
        <div class="treding_title">Yougotrated Live</div>
        <div class="filter"><span style="font-size:14px; font-weight:bold;">Filter by :</span> <a href="<?php echo site_url('welcome');?>" class="filter_active" title="Recent Activity">Recent Activity</a> <a href="<?php echo site_url('complaint/weektrending');?>" title="Trending Complaints">Trending Complaints (7 Days)</a><!-- <a href="#">Most Active (7 Days)</a>--><a href="<?php echo site_url('complaint/advfilter');?>" title="Advance Filter">Advance Filter</a></div>
