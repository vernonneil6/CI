	...
	public function __construct()
  {
  	parent::__construct();
		...
		elseif( $this->uri->segment(1) == 'review' && $this->uri->segment(2) == 'browse' )
		{
			...
			$this->data['description'] = 'Write Review In YGR,File complaintsIn YGR';
		}
		...
		if($this->input->post('type')=='checkPromocode'){ 
			if( $this->input->is_ajax_request() && ( $this->input->post('reviewpromo'))){
			    ...
			    if(!empty($promocodevalid))
				{
					...
					$nameStatus['promomsg'] = "Promo code validated!  The promotion details will appear after submitting this review.";
