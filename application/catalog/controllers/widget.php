...
class Widget extends CI_Controller {
	...
	public function business($companyid='')
	{
		...
		$this->data['reviews'] = $this->reviews->get_reviews_bycompanyid($companyid,$limit,$offset);
				
		$this->paging['base_url'] = site_url("widget/business/".$companyid);
		$this->paging['uri_segment'] = 3;
		$this->paging['total_rows'] = count($this->reviews->get_reviews_bycompanyid($companyid));
