...
<div id="content">
  ...
  <div class="breadcrumbs">
    <ul>
      ...
      <li>
        <?php if($this->uri->segment(2) == 'add'){echo 'Add Pdf';} else if($this->uri->segment(2) == 'edit') {echo 'Edit Pdf'; }?>
      </li>
  ...
  <div class="box">
    <div class="headlines">
      <h2><span>
        <?php if($this->uri->segment(2) == 'add') { echo "Add Pdf"; } ?>
        <?php if($this->uri->segment(2) == 'edit') { echo "Edit Pdf"; } ?>
        </span></h2>
    </div>
        ...
        <div class="form-cols"><!-- two form cols -->
          <div class="col1" style="width:100%">
            <div class="clearfix file">
              <div class="lab" style="width: 8% !important;">
                <label for="title">Pdf <span class="errorsign">*</span></label>
              </div>
              <div class="con" style="width: 59% !important; float:left">
                <?php if($this->uri->segment(2) == 'add') { ?>
