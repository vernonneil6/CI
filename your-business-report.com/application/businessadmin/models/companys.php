...
Class Companys extends CI_Model
{
	...
	//Updating Record
	function update($id,$company,$streetaddress,$city,$state,$country,$zip,$email,$siteurl,$paypalid,$logo,$phone,$about,$category,$creditcard1,$creditcard2)
 	{
	...
	function update_noimage($id,$company,$streetaddress,$city,$state,$country,$zip,$email,$siteurl,$phone,$about,$category,$creditcard1,$creditcard2)
 	{
		$date = date('Y-m-d H:i:s');
		$varipaddress = $_SERVER['REMOTE_ADDR'];
		$data = array(
