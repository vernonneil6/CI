    ...
    <div class="main_contentarea"><?php echo $menu; ?>
      <div class="login_box_div">
        ...
        <div class="login_box">
          ...
          <div class="login_box_title"><?php echo 'Login'; ?></div>
          ...
          <table align="left" width="850">
            <tbody>
              ...
              <tr>
                ...
                &nbsp;<a onclick="FBLogin();"><img src="<?php echo site_url(); ?>images/fb_signin_btn.png" alt="Signin with Facebook" title="Signin with Facebook"></a></div></td>
              </tr>
              <tr>
                <td></td>
        ...
        <!-- /box-content -->
        <div class="login_box">
          <div class="login_box_title"><?php echo 'Forgot Password'; ?></div>
