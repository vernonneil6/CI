  ...
  <section class="inner_main">
    ...
    <div id="main_contentarea"> <?php echo $menu; ?>
      <div class="login_box_div">
        ...
        <script type="text/javascript" language="javascript">
              ...
              else
              {
                  ...
                  return false;
                     ...
                     <?php /*?> <?php if( $this->uri->segment(2) != 'edit' ) { ?>
        ...
        <div class="login_box">
          ...
          <table class="data_table" align="left" width="900px">
            <tbody>
              ...
              <tr>
                <td valign="top"></td>
                <td id="tdterms"><?php echo form_checkbox(array('name'=>'terms','type'=>'checkbox','id'=>'terms','value'=>'Yes')); ?>&nbsp;I agree with the <a href="<?php echo site_url('terms');?>" target="_blank">Terms and Conditions</a></td>
		   ...
		   ?>" alt="<?php echo stripslashes($user[0]['firstname']); ?>"/> </div>
            ...
            <tr>
              <td><div class="login_box_title" style="font-size:16px;"><?php echo $user[0]['username']; ?></div>
                ...
                <div class="user_view"><a href="<?php echo site_url('user/comments'); ?>" title="Comments">Comments ( <?php echo count($totalcomments);?> )</a></div></td>
            </tr>
          </table>
          <?php }  ?>
          <table align="right" border="0">
            <tr>
              <td><div class="right_content_panel">
                  <div class="treding_title" style="border-bottom: 1px solid #CCCCCC; margin-bottom: 10px; padding-bottom: 5px; width:545px;font-size:16px;">Complaints</div>
        ...
        <?php	}
					else if( $this->uri->segment(2) && ( $this->uri->segment(2) == 'comments'))
					{ ?>
        <div class="login_box">
          <?php if( $this->session->userdata('youg_user') ){ ?>
          <table align="left" border="0" style="margin-top:22px;">
		   ...
		   ?>" alt="<?php echo stripslashes($user[0]['firstname']); ?>"/> </div>
            ...
            <tr>
              <td><div class="login_box_title" style="font-size:16px;"><?php echo $user[0]['username']; ?></div>
                ...
                <div class="user_view"><a href="<?php echo site_url('user/comments'); ?>" title="Comments"><span class="colorcode">Comments ( <?php echo count($totalcomments);?> )</span></a></div></td>
            </tr>
          </table>
          <?php }  ?>
          <table align="right" border="0">
            <tr>
              <td><div class="right_content_panel">
                  <div class="treding_title" style="border-bottom: 1px solid #CCCCCC; margin-bottom: 10px; padding-bottom: 5px; width:545px;font-size:16px;">Comments</div>
