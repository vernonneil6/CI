    ...
    <div class="head_bg">
      ...
      <div class="head_right">
        <div class="head_right_lnk">
          ...
          Welcome<a href="<?php echo site_url('user');?>" title="Dashboard"><?php echo $name; ?></a> <a href="<?php echo site_url('user/logout');?>" title="Logout">Logout</a>
          <?php } else {?>
          <a href="<?php echo site_url('login');?>" title="Login">Login</a>|<a href="<?php echo site_url('go/register');?>" title="Signup">Signup</a>
          <?php /*?><a href="#"><img src="<?php echo site_url(); ?>images/fb_signin_btn.png" alt="Signin with Facebook" title="Signin with Facebook" onclick="FBLogin();"></a><?php */?>
        ...
        <div class="main_searchbox">
          ...
          <?php if( $this->uri->segment(1)=='complaint' && $this->uri->segment(2)=='search') { $serkeyword=str_replace('-',' ',$this->uri->segment(3));} else { $serkeyword =''; } ?>
          
          <input name="search" placeholder="Search here..." class="search_box" type="text" value="<?php echo $serkeyword;?>" title="Search complaints" id="search" onKeyUp="searchcompany1(this.value)">
