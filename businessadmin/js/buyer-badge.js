...
document.getElementById("badge-seals").oncontextmenu=clickNS4;
document.getElementById("buyer-seals").oncontextmenu=clickNS4;

}
else if (document.all&&!document.getElementById){
document.getElementById("badge-seals").oncontextmenu=clickIE4;
document.getElementById("buyer-seals").oncontextmenu=clickIE4;
}

document.getElementById("badge-seals").oncontextmenu=new Function("alert(message);return false");
