	    	...
	    	<div class="main-content-area-container cf">
                ...
                <div class="main-content-area">
                    ...
                    <div class="latest-post<?php echo $has_img ? '':' no-post-image' ?>">
                        <h3 class="section-header"><span><?php _e('LATEST POST',OP_SN) ?></span></h3>
                        <?php if($has_img): ?>
                    ...
                    foreach ($postslist->posts as $post) :  setup_postdata($post); ?>
                        ...
                        <div class="older-post<?php echo $class ?>">
                            ...
                            <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', OP_SN ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" class="post-image"><?php the_post_thumbnail( 'list-image' ); ?></a>
                        <?php endif ?>
                            <?php echo $image ?>
                            <h4><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', OP_SN ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h4>
                            <?php the_excerpt() ?>
                            <?php op_post_meta() ?>
                        </div>
                    <?php endforeach; ?>
