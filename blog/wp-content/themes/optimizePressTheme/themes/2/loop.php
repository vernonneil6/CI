				...
				<div class="older-post-list cf">
					...
					if(has_post_thumbnail()){
						$image = '<a href="'.get_permalink().'" title="'.sprintf( esc_attr__( 'Permalink to %s', OP_SN ), the_title_attribute( 'echo=0' ) ).'" rel="bookmark" class="post-image">'.get_the_post_thumbnail( $post->ID, 'list-image' ).'</a>';
						$class = '';
					}
					 ?>
