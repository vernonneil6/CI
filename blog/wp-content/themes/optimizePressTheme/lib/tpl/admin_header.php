...
$admin_body_class .= $_GET['info_box'] == 'yes' || $_POST['op_info_box'] == 'yes' ? ' op-info-box-page' : '';
$admin_body_class .= $_GET['info_box_clean'] == 'yes' || $_POST['op_info_box_clean'] == 'yes' ? ' op-info-box-page-white' : '';
