...
<?php
    ...
    foreach($content_layouts_ordered as $content_layout) {
        foreach($data['op_template_sections'] as $op_template_section_title => $op_template_section_id) {
            if (strpos(strtolower($content_layout['name']), $op_template_section_title) !== false) {
                // $skip = false;
        ...
        <div id="<?php echo $template_section_id; ?>" class="op-template-section">
            <?php
                if ($content_layout['name'] == 'Opt-In Pages') {
                    $content_layout['name'] = 'Opt-in / Landing Pages';
                }
            ?>
                    ...
                    <div class="op-template-section-template">
                        ...
                        <div class="op-template-section-template-img-container" style="background-image:url('<?php echo $template['image'] ?>');">
                            <div class="op-template-section-template-img-btn-container">
                                <a class="op-template-section-template-img-btn" data-template-id="<?php echo $template['content_layout_id']; ?>"><?php echo __('Use This Template'); ?></a><br />
                                <a class="op-template-section-template-img-btn-alt" data-preview-url="<?php echo $preview_url; ?>" data-template-id="<?php echo $template['content_layout_id']; ?>"><?php echo __('or Preview this template'); ?></a>
                            </div>
...
<?php } ?>
    ...
    <div id="<?php echo $op_template_sections['blank']; ?>" class="op-template-section op-template-section-blank-page">
        <h2 class="op-template-section-title"><?php echo __('Blank Page'); ?></h2>
        <!--<a class="op-template-section-btn" href="#"><?php echo __('View Tutorial'); ?></a>-->
        <p class="op-template-section-description"><?php echo __('Create a blank page using one of our template frameworks'); ?></p>
            ...
            <?php foreach($data['blank_templates'] as $op_template) { ?>
                ...
                <div class="op-template-section-template">
                    <div class="op-template-section-template-img-container op-template-section-blank-template" style="background-image:url('<?php echo $op_template['screenshot_thumbnail']; ?>');">
                        <div class="op-template-section-template-img-btn-container">
                            <a class="op-template-section-template-img-btn" data-template-id="0" data-theme-id="<?php echo $op_theme_id; ?>"><?php echo __('Use This Template'); ?></a><br />
                            <a class="op-template-section-template-img-btn-alt" data-preview-url="<?php echo $op_template['screenshot']; ?>" data-template-id="0" data-is-image="true"><?php echo __('or Preview this template'); ?></a>
                        </div>
                        <div class="op-template-section-template-img-overlay"></div>
                    </div>
                    <div class="op-template-section-template-header">
