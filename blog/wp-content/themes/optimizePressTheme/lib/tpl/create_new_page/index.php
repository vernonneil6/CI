<div class="op-bsw-settings">
    ...
    <div class="op-bsw-main-content">
        ...
        */ ?>
        ...
        <div class="op-info-box">
            <p>
                <strong>New to OptimizePress?</strong> <a class="op-info-box-getting-started-link" id="js-op-info-box-getting-started-link">Click here to watch our Getting Started video</a>
            </p>
        ...
        <div class="op-info-box-panel">
            <ul class="op-info-box-list-icons">
                <li><a href="#<?php echo $op_template_sections['blank']; ?>" class="op-icon op-icon-blank-page"><?php echo __('Blank Pages'); ?></a></li>
                <li><a href="#<?php echo $op_template_sections['landing']; ?>" class="op-icon op-icon-landing-page"><?php echo __('Opt-in / Landing Pages'); ?></a></li>
                <li><a href="#<?php echo $op_template_sections['sales']; ?>" class="op-icon op-icon-sales-page"><?php echo __('Sales Pages'); ?></a></li>
                <li><a href="#<?php echo $op_template_sections['membership']; ?>" class="op-icon op-icon-membership-page"><?php echo __('Membership Pages'); ?></a></li>
                <li><a href="#<?php echo $op_template_sections['webinar']; ?>" class="op-icon op-icon-webinar-page"><?php echo __('Webinar Pages'); ?></a></li>
                <li><a href="#<?php echo $op_template_sections['launch']; ?>" class="op-icon op-icon-launch-funnel"><?php echo __('Launch Funnel Pages'); ?></a></li>
            </ul>
        </div>

        <div class="op-info-box">
            <div class="op-hiddens" id="upload_new_layout_container">
                <iframe class="op-iframe-full" src="<?php menu_page_url(OP_SN.'-page-builder') ?>&amp;section=content_upload&amp;info_box=yes" width="700" height="150"></iframe>
            </div>
        </div>
    ...
    <form id="op_asset_browser_container" class="op-create-page" action="<?php menu_page_url(OP_SN. '-page-builder', true); ?>&amp;step=1" method="post" enctype="multipart/form-data" class="form-step-1">
        ...
        <div class="op-content-preview">
            ...
            <div id="op_ajax_checker">
                <a href="#check" class="op-check-availability check-availability"><?php _e('Check availability', OP_SN) ?></a>
                <a href="#cancel" class="op-hidden check-availability-cancel op-check-availability-cancel"><?php _e('Cancel', OP_SN) ?></a>
            ...
            <div class="op-msgs">
                <div class="op-msg op-msg-success op-hidden">&#x2713;&nbsp; <?php _e('Available', OP_SN); ?></div>
                <div class="op-msg op-msg-error op-hidden">&#x2717;&nbsp; <?php _e('Unavailable', OP_SN); ?></div>
            </div>
            ...
            <script>
                if (typeof OptimizePress === 'object') {
                    ...
                    OptimizePress.create_new_page.slug_message = "<?php echo __('Please provide a valid URL slug which is not in use.',OP_SN); ?>";
                    OptimizePress.create_new_page.name_message = "<?php echo __('Please provide a name for your page.',OP_SN); ?>";
                }
            </script>
        </div>
