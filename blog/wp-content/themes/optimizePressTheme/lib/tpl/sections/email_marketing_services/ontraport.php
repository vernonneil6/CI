<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
    ...
    <p class="op-micro-copy"><?php _e('Use our Ontraport integration to add contacts who subscribe on your opt-in forms to Sequences inside Ontraport. <a href="http://optimizelink.com/ontraport-optin" target="_blank">Click here</a> to learn more about this feature', OP_SN); ?></p>
</div>