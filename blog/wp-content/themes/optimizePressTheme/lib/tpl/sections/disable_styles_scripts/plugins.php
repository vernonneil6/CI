<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
    ...
    <h3><?php _e('Disable on front-end (Published Pages)', OP_SN); ?></h3>
    <p class="op-micro-copy"><?php _e('Disable specific plugin JS or CSS codes from rendering on your live published pages.', OP_SN); ?></p>
    <table width="100%" class="op-disable-compat">
        <tr>
            <th align="left"><?php _e('Plugin name', OP_SN); ?></th>
            <th width="10%"><a href="#toggle-css" title="<?php _e('Toggle all checkboxes', OP_SN); ?>" data-type="css" class="op-disable-all-css"><?php _e('CSS', OP_SN); ?></a></th>
            <th width="10%"><a href="#toggle-js" title="<?php _e('Toggle all checkboxes', OP_SN); ?>" data-type="js" class="op-disable-all-js"><?php _e('JS', OP_SN); ?></a></th>
       </tr>
        <?php $hasActive = false; ?>
    ...
    <h3><?php _e('Disable for back-end (LiveEditor)', OP_SN); ?></h3>
    <p class="op-micro-copy"><?php _e("Disable specific plugin JS or CSS from rendering inside the LiveEditor (if you're having problems with editing in the LiveEditor).", OP_SN); ?></p>
    <table width="100%" class="op-disable-compat">
        <tr>
            <th align="left"><?php _e('Plugin name', OP_SN); ?></th>
            <th width="10%"><a href="#toggle-css" title="<?php _e('Toggle all checkboxes', OP_SN); ?>" class="op-disable-all-css" data-type="css"><?php _e('CSS', OP_SN); ?></a></th>
            <th width="10%"><a href="#toggle-js" title="<?php _e('Toggle all checkboxes', OP_SN); ?>" class="op-disable-all-js" data-type="js"><?php _e('JS', OP_SN); ?></a></th>
        </tr>
        <?php $hasActive = false; ?>
        <?php foreach ($plugins as $pluginId => $plugin) : if (!is_plugin_active($pluginId)) { continue; } ?>
        <?php $hasActive = true; ?>
