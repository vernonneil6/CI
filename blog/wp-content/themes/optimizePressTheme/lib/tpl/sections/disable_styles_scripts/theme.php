<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
    ...
    <p class="op-micro-copy"><?php _e('Disable theme JS or CSS codes from rendering on your live published pages.', OP_SN); ?></p>
    ...
    <p class="op-micro-copy"><?php _e("Disable theme JS or CSS from rendering inside the LiveEditor (if you're having problems with editing in the LiveEditor).", OP_SN); ?></p>
    <table width="100%" class="op-disable-compat">
        <tr>
            <th align="left"><?php _e('Theme name', OP_SN); ?></th>
            <th width="10%"><a href="#toggle-css" title="<?php _e('Toggle all checkboxes', OP_SN); ?>" data-type="css" class="op-disable-all-css"><?php _e('CSS', OP_SN); ?></a></th>
