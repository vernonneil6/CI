<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
    ...
    <label for="op_sections_analytics_and_tracking_in_body_tag_code" class="form-title"><?php _e('Tracking & Analytics Codes In Body',OP_SN) ?></label>
    <p class="op-micro-copy"><?php _e('Enter any tracking or analytics code which need to be placed after the &lt;body&gt; tag.',OP_SN) ?></p>
