<?php echo $this->load_tpl('header', array('title' => __('Launch Suite', OP_SN))); ?>
    ...
    <div class="op-bsw-main-content">
        ...
        <div id="launch_funnel_select"<?php echo $class1 ?>>
            <div class="funnel-dropdown">
                <strong><?php _e('Select the funnel to manage:',OP_SN); ?></strong>
                <?php echo $funnel_select; ?>
                <span><a href="#" id="funnel_switch_create_new"><?php _e('Create New',OP_SN); ?></a></span>
                <span><a class="button" href="#" id="funnel_delete"><?php _e('Delete This Funnel', OP_SN); ?></a></span>
            </div>
        </div>
