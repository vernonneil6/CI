...
class OptimizePress_LaunchSuite
{
    ...
    function delete_funnel()
    {
        ...
        if (wp_verify_nonce($nonce, $nonceChk)) {
            ...
            wp_send_json_success(array('message' => __('Funnel deleted successfully.', OP_SN)));
        } else {
            wp_send_json_error(array('error' => __('Verification failed, please refresh the page and try again.', OP_SN)));
        }
