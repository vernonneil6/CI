;(function($){
    ...
    ;(function () {
         ...
         * (for tracking op updates and clearing localstorage upon version change).
         * @param {string} key
         * @param {string} value
         */
        OptimizePress.localStorage.setItem = function (key, value) {
            ...
            localStorage.setItem('op_' + key + '_' + OptimizePress.version, value);
            return true;
        }

        /**
         * Returns the value of the key (key is retrieved with op prefix and op_version suffix)
         * @return {string}
         */
        OptimizePress.localStorage.getItem = function (key) {
            ...
            return localStorage.getItem('op_' + key + '_' + OptimizePress.version);
        }
