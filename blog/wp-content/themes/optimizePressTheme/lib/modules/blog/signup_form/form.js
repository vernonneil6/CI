    ...
    var op_optin = function($t){
        ...
        self.$t.find('.integration_type_select').change(function(e) {
            ...
            switch (integrationType) {
                ...
                case 'activecampaign':
                case 'emma':
                    hide = 'div.field-double-optin,p.field-welcome-email,p.form_html_field,div.form_html_field,div.email_data_field,p.email_data_field,p.new_window,p.action_page,p.email_html_field';
                    ...
                    break;
                case 'egoi':
                    hide = 'div.field-double-optin,p.field-welcome-email,div.field-signup-form-id,p.email_data_field,p.form_html_field,div.form_html_field,div.email_data_field,p.new_window,p.action_page,p.email_html_field';
                    show = 'p.provider_list,p.name_html_field,p.thank_you_page,div.extra_fields,div.provider_list_note,.form_html_info_field';
                    doIntegrationType(integrationType);
                    break;
                case 'maropost':
                    hide = 'div.field-signup-form-id,div.field-double-optin,p.field-welcome-email,p.form_html_field,div.form_html_field,div.email_data_field,p.new_window,p.action_page,p.email_html_field';
                    show = 'p.provider_list,p.name_html_field,p.thank_you_page,div.extra_fields,div.provider_list_note,.form_html_info_field';
                    doIntegrationType(integrationType);
                    break;
            }
