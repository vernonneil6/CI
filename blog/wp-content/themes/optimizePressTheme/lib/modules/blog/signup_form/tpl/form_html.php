        ...
        for($i=0,$il=count($field_names);$i<$il;$i++):
            ...
            <div class="op-multirow cf">
                ...
                <div class="form_html_field_required">
                    ...
                    <input type="checkbox" name="<?php echo $fieldname ?>[form_html][extra_fields][required][]" id="<?php echo $field_id ?>required" value="Y" <?php checked((isset($fields['email_extra_fields_required'][$i]) ? op_attr($fields['extra_fields']['required'][$i]) : 'N'), 'Y'); ?> />
                </div>
