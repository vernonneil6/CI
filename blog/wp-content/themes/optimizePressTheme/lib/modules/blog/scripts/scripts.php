                ...
                $content .= '
                    <li>
                        <select name="'.$name.'[position][]">
                            ...
                            <option value="in_body_tag"'.selected('in_body_tag', $item['position'], false).'>'.__('After &lt;body&gt; tag',OP_SN).'</option>
            ...
            <?php foreach($items as $item): ?>
                <li>
                    <select name="<?php echo $name  ?>[position][]">
                        ...
                        <option value="in_body_tag"<?php selected('in_body_tag', $item['position']); ?>><?php _e('After &lt;body&gt; tag',OP_SN); ?></option>
