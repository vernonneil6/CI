...
'.urldecode($title).
($hide_like != 'Y' ? '
    <fb:like href="'.$src_url.'" send="false"'.' show_faces="false"'.$color_scheme.' font="arial" data-width="100%" class="op-fbComments--like"></fb:like>':'').'
    <fb:comments href="'.$src_url.'"'.$color_scheme.' num_posts="'.$posts_number.'" publish_feed="true" migrated="1" data-width="100%" class="op-fbComments--comments"></fb:comments>
</div>';
// xid="'.$xid.'"
