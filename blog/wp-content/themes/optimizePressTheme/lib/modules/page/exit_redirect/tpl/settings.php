<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
    <p class="op-warning-message op-warning-message--spaced">
        <?php
        echo __('<strong>Important:</strong> We strongly recommend using our new OverlayPop Feature for triggering an OverlayOptimizer element on the exit of your page.  Using a hard exit redirect is often against the terms of many advertising networks (e.g. Facebook) and can lead to your account being banned if you drive traffic to pages which include this feature.', OP_SN);
        ?>
    </p>
